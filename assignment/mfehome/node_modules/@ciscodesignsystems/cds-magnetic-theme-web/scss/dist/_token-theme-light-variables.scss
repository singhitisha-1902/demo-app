...
$brand-text-weak-default: #f7f7f7 !default;
...
$brand-accent-icon-default: #7e868f !default;
$brand-accent-icon-focus: #ffffff !default;
$brand-accent-icon-active: #45991f !default;
$brand-accent-icon-disabled: #d0d4d9 !default;
$brand-accent-icon-weak-default: #c1c6cc !default;
$brand-accent-icon-weak-focus: #ffffff !default;
$brand-accent-icon-weak-active: #6bbf41 !default;
$brand-accent-icon-weak-disabled: #d0d4d9 !default;
$brand-accent-icon-medium-default: #a7adb5 !default;
$brand-accent-icon-medium-focus: #ffffff !default;
$brand-accent-icon-medium-active: #52a62b !default;
$brand-accent-icon-medium-disabled: #d0d4d9 !default;
$brand-accent-border-default: #52a62b !default;
$brand-accent-border-hover: #e1e4e8 !default;
$brand-accent-border-focus: #45991f !default;
$brand-accent-border-active: #45991f !default;
...
$brand-accent-border-weak-active: #6bbf41 !default;
$brand-accent-border-weak-disabled: #ffffff !default;
$brand-accent-border-medium-default: #f0f1f2 !default;
$brand-accent-border-medium-hover: #ffffff !default;
$brand-accent-border-medium-focus: #ffffff !default;
$brand-accent-border-medium-active: #e0f5d5 !default;
$brand-accent-border-medium-disabled: #ffffff !default;
$brand-accent-border-strong-default: #f7f7f7 !default;
$brand-accent-border-strong-hover: #f7f7f7 !default;
$brand-accent-border-strong-focus: #f7f7f7 !default;
$brand-accent-border-strong-active: #f7f7f7 !default;
...
$base-bg-medium-hover: #d0d4d9;
$base-bg-medium-active: #e1e4e8;
...
$decent-bg-medium-default: #d5f5f5;
$decent-bg-medium-hover: #d5f5f5;
$decent-bg-medium-focus: #d5f5f5;
$decent-bg-medium-active: #d5f5f5;
$decent-bg-medium-disabled: #f7f7f7;
$decent-icon-default: #028e99;
$decent-icon-hover: #028e99;
$decent-icon-focus: #028e99;
$decent-icon-active: #028e99;
$decent-icon-disabled: #d0d4d9;
$decent-icon-in-default: #ffffff;
$decent-icon-in-hover: #ffffff;
$decent-icon-in-focus: #ffffff;
$decent-icon-in-active: #ffffff;
$decent-icon-in-disabled: #ffffff;
$decent-border-default: #028e99;
$decent-border-hover: #028e99;
$decent-border-focus: #028e99;
$decent-border-active: #028e99;
$decent-border-disabled: #d0d4d9;
