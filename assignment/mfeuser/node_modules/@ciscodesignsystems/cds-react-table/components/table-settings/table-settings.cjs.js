...
var cdsReactDrawer = require('@ciscodesignsystems/cds-react-drawer');
...
const CDSTableConfiguration = ({
  ...
  return jsxRuntime.jsxs(cdsReactDrawer.CDSDrawer, {
    onClose: onClose,
    ...rest,
    children: [jsxRuntime.jsx(cdsReactDrawer.CDSDrawer.Heading, {
      children: "Select columns"
    }), jsxRuntime.jsxs(cdsReactDrawer.CDSDrawer.Content, {
      children: [jsxRuntime.jsx("p", {
      ...
      }), jsxRuntime.jsx(cdsReactFlex.CDSFlex, {
        direction: "vertical",
        gap: 4,
        margin: [8, 0],
        ...
        children: table.getAllLeafColumns().filter(column => !constants.EXCLUDED_COLUMNS.includes(column.id)).map(column => {
          var _a;
          return jsxRuntime.jsx(cdsReactCheckbox.CDSCheckbox, {
            id: column.id,
    ...
    }), jsxRuntime.jsxs(cdsReactDrawer.CDSDrawer.Footer, {
      children: [jsxRuntime.jsx(cdsReactButton.CDSButton, {
        variant: "tertiary",
        onClick: onClose,
        children: "Cancel"
      }), jsxRuntime.jsx(cdsReactButton.CDSButton, {
        variant: "primary",
        onClick: event => {
