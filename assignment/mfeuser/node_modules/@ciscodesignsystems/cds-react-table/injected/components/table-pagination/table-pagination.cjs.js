...
var injected$1 = require('@ciscodesignsystems/cds-react-select/injected');
...
const CDSTablePagination = ({
  ...
  return jsxRuntime.jsxs(injected.CDSFlex, {
    ...
    justify: "flex-end",
    className: className,
    children: [paginationConfig.showPageSizeChanger && computedPageSizeOptions.length > 0 ? jsxRuntime.jsxs(injected.CDSFlex, {
      gap: 8,
      justify: "flex-end",
      children: [jsxRuntime.jsx("span", {
        className: cdsComponentUtilities.cx(tablePagination_module["default"], 'cds-table__pagination__page-size__label'),
        children: "Rows per page"
      }), jsxRuntime.jsx(injected$1.CDSSelect, {
        style: {
          width: 'fit-content'
        },
