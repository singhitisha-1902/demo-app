...
var injected$2 = require('@ciscodesignsystems/cds-react-empty-state/injected');
var injected = require('@ciscodesignsystems/cds-react-flex/injected');
var injected$3 = require('@ciscodesignsystems/cds-react-label/injected');
...
const CDSSelect = /*#__PURE__*/react.forwardRef((props, ref) => {
  ...
  const renderLabel = (name, label, required, infoMessage, optional) => {
    return jsxRuntime.jsx(injected$3.CDSLabel, {
      size: size,
      htmlFor: name,
  ...
  return jsxRuntime.jsx("div", {
    ...
    ref: mergedRefs,
    ...rest,
    children: jsxRuntime.jsx(injected.CDSFlex, {
      direction: "vertical",
        ...
        children: [label && renderLabel(name, label, required, infoMessage, optional), jsxRuntime.jsxs("div", {
          ...
          children: [jsxRuntime.jsxs("div", {
            ...
            children: [hasSelectedOptions() && !multiple && !inputValue && jsxRuntime.jsxs("div", {
              ...
              children: [...getSelectedOptions()].map(option => jsxRuntime.jsx(injected$1.CDSTooltip, {
                autoPlacement: true,
            ...
            }) : jsxRuntime.jsx(injected$1.CDSTooltip, {
            ...
            children: isMenuOpen && jsxRuntime.jsx(react$1.FloatingFocusManager, {
              ...
              children: jsxRuntime.jsxs("div", {
                ...
                children: [options && !hasOptionsGroups && getOptions().map(renderOptionElement), hasOptionsGroups && getOptions().map((group, index) => {
                  ...
                  children: jsxRuntime.jsxs(injected$2.CDSEmptyState, {
                    children: [jsxRuntime.jsx(injected$2.CDSEmptyState.Illustration, {
                      variant: "info"
                    }), jsxRuntime.jsx(injected$2.CDSEmptyState.Message, {
