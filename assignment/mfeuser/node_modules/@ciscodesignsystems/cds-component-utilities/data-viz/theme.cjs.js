  ...
  axis: {
    ...
    ticks: {
      ...
      text: {
        ...
        fontSize: fontSize !== null && fontSize !== void 0 ? fontSize : 14
      }
    }
  },
  crosshair: {
...
const mergeTheme = (fontSize, theme) => theme ? ramda.mergeDeepRight({
  ...getDefaultChartTheme(fontSize),
  fontSize
}, theme) : getDefaultChartTheme(fontSize);

exports.getDefaultChartTheme = getDefaultChartTheme;
