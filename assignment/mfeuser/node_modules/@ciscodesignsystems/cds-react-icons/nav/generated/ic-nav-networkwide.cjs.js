...
const IcNavNetworkwide = /*#__PURE__*/react.forwardRef(({
  size,
  ...rest
}, ref) => {
  return jsxRuntime.jsxs("svg", {
    ...
    children: [jsxRuntime.jsx("path", {
      ...
      d: "M15.6421 5.15713C15.8519 4.69678 15.977 4.18968 15.9975 3.65576C17.8951 4.56641 19.434 6.10532 20.3447 8.00295C19.8108 8.0234 19.3037 8.1485 18.8433 8.35832C18.1186 6.99944 17.001 5.88181 15.6421 5.15713Z",
      fill: "var(--brand-accent-icon-medium-default, #a7adb5)"
    }), jsxRuntime.jsx("path", {
      d: "M18.8433 15.6416C18.1186 17.0005 17.001 18.1181 15.6421 18.8428C15.8519 19.3032 15.977 19.8103 15.9975 20.3442C17.8951 19.4335 19.434 17.8946 20.3447 15.997C19.8108 15.9765 19.3037 15.8515 18.8433 15.6416Z",
      fill: "var(--brand-accent-icon-medium-default, #a7adb5)"
    }), jsxRuntime.jsx("path", {
      d: "M5.15762 15.6416C5.8823 17.0005 6.99992 18.1181 8.35881 18.8428C8.14899 19.3032 8.02389 19.8103 8.00345 20.3442C6.10581 19.4335 4.5669 17.8946 3.65625 15.997C4.19017 15.9765 4.69727 15.8515 5.15762 15.6416Z",
      fill: "var(--brand-accent-icon-medium-default, #a7adb5)"
    }), jsxRuntime.jsx("path", {
      d: "M5.15762 8.35832C5.8823 6.99943 6.99992 5.88181 8.35881 5.15713C8.14899 4.69678 8.02389 4.18968 8.00344 3.65576C6.10581 4.56641 4.5669 6.10532 3.65625 8.00295C4.19017 8.0234 4.69727 8.1485 5.15762 8.35832Z",
      fill: "var(--brand-accent-icon-medium-default, #a7adb5)"
    }), jsxRuntime.jsx("path", {
      ...
      d: "M14 20.5C14 21.6046 13.1046 22.5 12 22.5C10.8954 22.5 10 21.6046 10 20.5C10 19.3954 10.8954 18.5 12 18.5C13.1046 18.5 14 19.3954 14 20.5Z",
      fill: "var(--brand-accent-icon-default, #7e868f)"
    }), jsxRuntime.jsx("path", {
      d: "M3.5 14C4.60457 14 5.5 13.1046 5.5 12C5.5 10.8954 4.60457 10 3.5 10C2.39543 10 1.5 10.8954 1.5 12C1.5 13.1046 2.39543 14 3.5 14Z",
      fill: "var(--brand-accent-icon-default, #7e868f)"
    })]
  });
});
IcNavNetworkwide.displayName = 'IcNavNetworkwide';
IcNavNetworkwide.defaultProps = {
  size: 24
};

exports.IcNavNetworkwide = IcNavNetworkwide;
exports["default"] = IcNavNetworkwide;
