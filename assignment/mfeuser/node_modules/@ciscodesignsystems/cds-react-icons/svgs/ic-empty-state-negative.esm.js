...
const IcEmptyStateNegative = /*#__PURE__*/forwardRef(({
  height,
  width,
  ...rest
}, ref) => {
  return /*#__PURE__*/jsxs("svg", {
    ...
    children: [/*#__PURE__*/jsx("rect", {
      fill: "var(--negative-icon-weak-default)",
      height: "160",
      opacity: ".4",
      rx: "18",
      ...
      fill: "var(--negative-icon-in-default)"
    }), /*#__PURE__*/jsx("circle", {
      cx: "170",
      cy: "194.667",
      fill: "var(--negative-icon-in-default)",
...
IcEmptyStateNegative.displayName = 'IcEmptyStateNegative';
IcEmptyStateNegative.defaultProps = {
  height: 255,
  width: 255
};

export { IcEmptyStateNegative, IcEmptyStateNegative as default };
